 ...
 *
 * IN:
 *      Body: lastname, begin_of_first_working_day, contact_person, documents_needed_for_first_working_day, private_email
 *
 * Out:
 *      Body: email
...
public class InfoForFirstWorkingDayProcessor implements Processor {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        headers.put("Subject", "Informationen für Ihren ersten Arbeitstag");
